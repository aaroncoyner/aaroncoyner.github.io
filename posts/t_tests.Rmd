...
### Acknowledgements
This tutorial was ported to R from [Amber Lin's](https://ohsu-psu-sph.org/faculty-directory/name/amber-lin/) tutorials for PHPM 524: Introduction to Biostatistics at Oregon Health & Science University.
